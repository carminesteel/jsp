 ...
 * Generated at: 2020-06-02 06:07:31 UTC
...
public final class insert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<td width=300><input type=text name=\"sname\" maxlength=8 value=\"홍길동\" size=5></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option selected>건축</option>\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"title\" width=100>생년월일</td>\r\n");
      out.write("\t\t\t\t\t\t<td width=300>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=text name=\"yy\" maxlength=4 size=2 placeholder=\"yyyy\">년\r\n");
      out.write("\t\t\t\t\t\t\t<input type=text name=\"mm\" maxlength=2 size=2 placeholder=\"mm\">월\r\n");
      out.write("\t\t\t\t\t\t\t<input type=text name=\"dd\" maxlength=2 size=2 placeholder=\"dd\">일\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"title\" width=100>학년</td>\r\n");
      out.write("\t\t\t\t\t\t<td width=300>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=radio name=\"year\" maxlength=1 value=\"1\" size=2 checked>1학년\r\n");
      out.write("\t\t\t\t\t\t\t<input type=radio name=\"year\" maxlength=1 value=\"2\" size=2>2학년\r\n");
      out.write("\t\t\t\t\t\t\t<input type=radio name=\"year\" maxlength=1 value=\"3\" size=2>3학년\r\n");
      out.write("\t\t\t\t\t\t\t<input type=radio name=\"year\" maxlength=1 value=\"4\" size=2>4학년\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"title\" width=100>지도교수</td>\r\n");
      out.write("\t\t\t\t\t\t<td width=300>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"pcode\" size=4 readonly placeholder=\"교수번호\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"pname\" size=5 readonly placeholder=\"교수이름\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      ...
      out.write("\t\t\talert(\"학번, 학생이름을 입력하세요!\"); return;\r\n");
