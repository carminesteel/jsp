 ...
 * Generated at: 2020-06-05 01:20:27 UTC
...
public final class read_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<div id=\"divHeader\"><h2>강 좌 등 록</h2></div>\r\n");
      out.write("\t\t\t<form name=\"frm\" action=\"update\" method=\"post\">\r\n");
      out.write("\t\t\t\t <table>\r\n");
      out.write("\t\t\t\t\t <tr>\r\n");
      out.write("\t\t\t\t\t\t <td class=\"title\">강좌번호</td><td><input type=\"text\" size=10 name=\"lcode\" value=\"");
      ...
      out.write("\t\t\t\t\t\t <td class=\"title\" width=150>강의실</td><td><input type=\"text\" size=5 name=\"room\" value=\"");
      ...
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t <td class=\"title\" width=150>강의시수</td><td><input type=\"text\" size=5 name=\"hours\" value=\"");
      ...
      out.write("\t\t\t\t\t </tr>\r\n");
      out.write("\t\t\t\t\t <tr>\r\n");
      out.write("\t\t\t\t\t\t <td class=\"title\">강좌이름</td><td colspan=3><input type=\"text\" size=60 name=\"lname\" readonly value=\"");
      ...
      out.write("\"></td>\r\n");
      out.write("\t\t\t\t\t\t <td class=\"title\">최대수강인원</td><td><input type=\"text\" size=5 name=\"capacity\" value=\"");
      ...
      out.write("\t\t\t<div>\r\n");
      out.write(" \t\t\t\t<button id=btnUpdate style= \"margin-left:91px;margin-bottom:10px;\">선택저장</button>\r\n");
      out.write(" \t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<td width=100>학과</td>\r\n");
      out.write("\t\t\t\t\t<td width=100>학년</td>\r\n");
      out.write("\t\t\t\t\t<td width=150>수강일</td>\r\n");
      out.write("\t\t\t\t\t<td width=100>점수</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t{{#each array}}\r\n");
      out.write("\t\t\t\t<tr class=\"row\">\r\n");
      out.write("\t\t\t\t\t<td class=\"lcode\"><input type = \"checkbox\" class=\"chk\"></td>\r\n");
      ...
      out.write("\t\t\t\t\t<td><input type = \"text\" class=\"grade\" size=1 value={{grade}} ><button>수정</button></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t{{/each}}\r\n");
      out.write(" \t\t\t</script>\r\n");
      out.write(" \t\t\t\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t$(\"#tbl\").on(\"change keyup paste\",\".row .grade\", function(e){\r\n");
      ...
      out.write("\t})\r\n");
      out.write("\t\r\n");
      out.write("\t//전체체크 버튼 눌렀을 때\r\n");
      out.write("\t$(\"#tbl\").on(\"click\",\".title #chkAll\",function(){\r\n");
      out.write("        if($(\"#chkAll\").prop(\"checked\")){\r\n");
      out.write("            $(\"input[class=chk]\").prop(\"checked\",true);\r\n");
      out.write("        }else{\r\n");
      out.write("            $(\"input[class=chk]\").prop(\"checked\",false);\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("\t\r\n");
      out.write("\t//각 행의 체크버튼 클릭한 경우\r\n");
      out.write("\t$(\"#tbl\").on(\"click\",\".row .chk\",function(){\r\n");
      out.write("\t\tvar isChkAll=true;\r\n");
      out.write("\t\t$(\"input[class=chk]\").each(function(){if(!$(this).is(\":checked\")) isChkAll=false;});\r\n");
      out.write("\t\tif(isChkAll){\r\n");
      out.write("\t\t\t$(\"input[id=chkAll]\").prop(\"checked\", true);\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$(\"input[id=chkAll]\").prop(\"checked\", false);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\ttype:\"get\",\r\n");
      out.write("\t\t\turl:\"/courses/delete\",\r\n");
      out.write("\t\t\tdata:{\"lcode\":lcode},\r\n");
      out.write("\t\t\tdataType:\"json\",\r\n");
      out.write("\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\tif(data.count==0){\r\n");
      out.write("\t\t\t\t\talert(lname+\"삭제되었습니다.\");\r\n");
      out.write("\t\t\t\t\tlocation.href=\"list.jsp\";\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\talert(data.count+\"명이 남았음\")\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t})\r\n");
      out.write("\t})\r\n");
