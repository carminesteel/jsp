	...
	<div id="divPage">
		...
		<form name="frm" action="update" method="post"
			...
			<table id="tbl">
				...
				<tr>
					<td class="title" width=100>업체코드</td>
				...
				<tr>
					...
					<td colspan=3><input type="text" name="prod_name" size=50
						value="${vo.prod_name}"></td>
					<td class="title" width=100>판매상태</td>
					<td><input type="checkbox" name="prod_del" value=1
						<c:out value="${vo.prod_del=='1'?'checked':''}"/>> 판매중지</td>
				</tr>
				<tr>
					<td class="title" width=100>상품이미지</td>
					<td colspan=5><c:if test="${vo.image==null}">
							<img src="http://placehold.it/150x120" id="image" width=150 />
						</c:if> <c:if test="${vo.image!=null}">
